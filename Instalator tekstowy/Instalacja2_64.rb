...
st = gets.chomp!
if st == "t"
all << "steam lib32-glibc lib32-libstdc++5 lib32-qt4 lib32-alsa-lib "
elsif st == "n"
print "Zrezygnowano z instalacji programu."
end
puts "
...
if d == "1"
system "pacman -S nvidia lib32-nvidia-libgl --noconfirm"
elsif d == "2"
system "pacman -S nvidia-304xx lib32-nvidia-304xx-utils --noconfirm"
elsif d == "3"
